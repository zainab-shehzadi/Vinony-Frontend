...
export default function ModelCharacteristics({ items }: Props) {
  ...
  return (
    <section className="mt-6 md:mt-10">
      <h2 className="text-xl font-extrabold text-slate-900 md:text-2xl lg:text-3xl">
        Model <span className="text-primary">characteristics</span>
      </h2>

      <ul className="mt-4 space-y-1 text-sm leading-7 text-foreground md:text-base lg:text-[18px]">
        {items.map((c, idx) => (
